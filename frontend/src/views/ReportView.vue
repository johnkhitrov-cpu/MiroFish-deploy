<template>
  <div class="main-view">
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step4 Генерация отчёта -->
...
// Layout State — по умолчанию переключено на рабочий стол
...
const loadReportData = async () => {
  try {
    ...
    if (reportRes.success && reportRes.data) {
      ...
      addLog(`Ошибка получения отчёта: ${reportRes.error || 'неизвестная ошибка'}`)
    }
  } catch (err) {
...
onMounted(() => {
  addLog('Инициализация ReportView')
  loadReportData()
})
</script>
