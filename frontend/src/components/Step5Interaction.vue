          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Диалог с любым индивидом мира' }}</span>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Неизвестная профессия' }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Согласование реальных начальных данных с состоянием среды симуляции, использование механизма Global/Local Memory для кросс-темпоральной глубокой атрибуции</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Алгоритм обхода графа в ширину для реконструкции путей распространения событий и захвата топологии информационных потоков</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Интерфейс мгновенных запросов на основе GraphRAG с оптимизированной индексацией для быстрого извлечения атрибутов узлов и дискретных фактов</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Автономное интервью с параллельным многораундовым диалогом с индивидами симулированного мира для сбора неструктурированных данных о мнениях и психологических состояниях</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'Неизвестная профессия' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Описание</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Диалог с Report Agent для углублённого изучения отчёта' : 'Диалог с симулированным индивидом для изучения его мнений' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Выбрать респондентов</span>
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'Неизвестная профессия' }}</span>
                  </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'Неизвестная профессия' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // Кеш всех записей диалогов: { 'report_agent': [], 'agent_0': [], ... }
...
// Сохранение текущих записей диалога в кеш
...
const selectReportAgentChat = () => {
  // Сохранение текущих записей диалога
  saveChatHistory()
  ...
  // Восстановление записей диалога Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Восстановление записей диалога этого Agent
  chatHistory.value = chatHistoryCache.value[`agent_${idx}`] || []
  addLog(`Выбран собеседник: ${agent.username}`)
}
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Автосохранение записей диалога в кеш
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(`Отправка Report Agent: ${message.substring(0, 50)}...`)
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Интервьюер' : 'Вы'}：${msg.content}`)
      .join('\n')
    prompt = `Вот наш предыдущий диалог：\n${historyContext}\n\nМой новый вопрос：${message}`
  }
  ...
  if (res.success && res.data) {
    // Правильный путь данных: res.data.result.results — словарь объектов
    // Формат: {"twitter_0": {...}, "reddit_0": {...}} или одна платформа {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Преобразование словаря объектов в массив с приоритетом ответов Reddit
...
const submitSurvey = async () => {
  ...
  addLog(`Отправка анкеты ${selectedAgents.value.size} респондентам...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      // Правильный путь данных: res.data.result.results — словарь объектов
      // Формат: {"twitter_0": {...}, "reddit_0": {...}, "twitter_1": {...}, ...}
      const resultData = res.data.result || res.data
      const resultsDict = resultData.results || resultData
      
      // Преобразование словаря объектов в формат массива
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Загружено ${profiles.value.length} симулированных индивидов`)
    }
  } catch (err) {
    addLog(`Ошибка загрузки симулированных индивидов: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Инициализация глубокого взаимодействия')
  loadReportData()
  loadProfiles()
...
/* Left Panel - Report Style (идентично Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Исправление нумерации упорядоченных списков — CSS-счётчики для последовательной нумерации */
.message-text {
...
/* Стили цитат в области чата/анкеты */
