  ...
  <div class="workbench-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM анализирует содержание документов и требования симуляции, извлекает реальные зёрна и автоматически генерирует подходящую структуру онтологии
          </p>
          ...
          <div v-if="projectData?.ontology?.entity_types" class="tags-container" :class="{ 'dimmed': selectedOntologyItem }">
            <span class="tag-label">СГЕНЕРИРОВАННЫЕ ТИПЫ СУЩНОСТЕЙ</span>
            <div class="tags-list">
              <span 
          ...
          <div v-if="projectData?.ontology?.edge_types" class="tags-container" :class="{ 'dimmed': selectedOntologyItem }">
            <span class="tag-label">СГЕНЕРИРОВАННЫЕ ТИПЫ СВЯЗЕЙ</span>
            <div class="tags-list">
              <span 
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            На основе сгенерированной онтологии документы автоматически разбиваются на блоки, затем через Zep строится граф знаний, извлекаются сущности и связи, формируются временна́я память и обзоры сообществ
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Типы схемы</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="system-logs">
      <div class="log-header">
        ...
        <span class="log-id">{{ projectData?.project_id || 'НЕТ_ПРОЕКТА' }}</span>
      </div>
...
// Перейти к настройке среды — создать simulation и перенаправить
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      // Перенаправление на страницу simulation
      router.push({
        name: 'Simulation',
    ...
    console.error('Исключение при создании симуляции:', err)
    alert('Исключение при создании симуляции: ' + err.message)
  } finally {
